...
INSERT INTO Species (name,watering_period,fertilization_period) VALUES ('Papro�',4,35);
...
INSERT INTO Plants (login,plant_species, plant_name,watering_period,fertilization_period,last_watering_date, last_fertilization_date, plant_description)
    VALUES ('IrenkaSawicka', 3, 'Ma�a monstera', 8, 20, CAST( NOW() AS Date ), CAST( NOW() AS Date ), 'Ro�lina posiada prz�dziorki');
...
INSERT INTO SpecialEvent (plant_id, event_name, event_description, event_date) VALUES (8, 'Opryskanie ro�liny ','Ro�lina ma prz�dziorki', '2023-09-01');
...
INSERT INTO SpecialEvent (plant_id, event_name, event_date) VALUES (8, 'Opryskanie ro�liny',  CAST( NOW() AS Date ));